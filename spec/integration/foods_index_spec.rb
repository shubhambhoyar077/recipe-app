...
RSpec.describe 'Foods', type: :system do
  describe 'Food list index page' do
    before do
      ...
      @food = Food.create!(name: 'food1', measurement_unit: 'grams', price: 2, quantity: 4, user: @user)
      @food = Food.create!(name: 'food2', measurement_unit: 'grams', price: 3, quantity: 4, user: @user)
      visit foods_path
    ...
    #   click_button 'REMOVE', id: "delete-btn-#{@food.id}"
    #   expect(page).to_not have_content('food1')
    #   expect(page).to have_content('food2')
    # end
  end
end
